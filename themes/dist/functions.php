...

    {
        ...
        if (function_exists('acf_register_block')) {
            ...
            acf_register_block(array(
                ...
                'name' => 'block_uebung', // Interner Name

                'title' => __('block_uebung', 'wifi'), // Titel (Anzeigename)

                'description' => __('Block_uebung', 'wifi'), // Beschreibung (wird im Editor bei der Blockauswahl angezeigt)

                'supports' => array('anchor' => true), // Ermöglicht bei den Block-Einstellungen eine ID (Anchor) einzufügen

                'render_template' => 'template-parts/block-uebung.php', // Pfad zum Template (HTML & PHP) des Gutenberg-Block
            ...
            acf_register_block(array(
                ...
                'name' => 'wifi_blog', // Interner Name

                'title' => __('Blogbeiträge', 'wifi'), // Titel (Anzeigename)

                'description' => __('Gibt 2 Beiträge aus', 'wifi'), // Beschreibung (wird im Editor bei der Blockauswahl angezeigt)

                'supports' => array('anchor' => true), // Ermöglicht bei den Block-Einstellungen eine ID (Anchor) einzufügen

                'render_template' => 'template-parts/block-blog.php', // Pfad zum Template (HTML & PHP) des Gutenberg-Block

                'category' => 'wifi-category', // in welcher Kategorie der Block erscheint - in diesem Fall in unserer eigenen Kategorie, die mit "add_action('block_categories'..)" angelegt wurde

                'icon' => 'post-status', // https://developer.wordpress.org/resource/dashicons/#smiley

                'keywords' => array('Beiträge', 'Blog'), // optional für die Suche im Editor
